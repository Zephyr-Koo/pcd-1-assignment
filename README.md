...
A format specifier can be identifier with a percent '%' prefix. (i.e %c for character and %d for integer)
...
**Code snippet**:
    ...
    int correctAnswer = (operation == OPERATION_SUBTRACTION ? 1 : 0); // initialize with identity element
...
## Suppress deprecated function call
